...
#
# From: https://github.com/thedataincubator/pylicense
# by Michael Li, (C) 2016 The Data Incubator
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(
        description='Adds license information to dependency file (i.e. requirements.txt or environment.yml) as comment')
    parser.add_argument('-e', '--environment', action='store_true', default=False,
                        help='file is environment.yml format (requirements.txt is default)')
    parser.add_argument('-s', '--stdout', action='store_true', default=False,
                        help='print new dependency file to stdout (default rewrites input file)')
